import { generatePossessiveAffix, generateEveryVerbAffix } from "./affix_generator.js";
                ...
                {       
                    ...
                    {                       
                        describe("Présent", () =>
                        {
                            ...
                            let results = generateEveryVerbAffix('michi', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, false, false);
                            test(expected, results);
                        });
                        describe("Passé", () => 
                        {                     
                            let expected = ["n'michib","k'michib","michob","n'michibnob","k'michibnob","k'michib8b", "michobanik"];
                            let results = generateEveryVerbAffix('michi', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST, false, false);
                            test(expected, results);
                        });
                        describe("Passé composé", () => 
                        {                     
                            let expected = ["kizi n'michi","kizi k'michi","kizi micho","kizi n'michibna","kizi k'michibna","kizi k'michiba", "kizi michoak"];
                            let results = generateEveryVerbAffix('michi', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, false, false);
                            test(expected, results);
                        });
                        describe("Future", () => 
                        {   
                            let expected = ["n'michiji","k'michiji","michoji","n'michibnaji","k'michibnaji","k'michibaji", "michoakji"];
                            let results = generateEveryVerbAffix('michi', undefined, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, false, false);
                            test(expected, results);
                        });
                        describe("Conditionnel", () => 
                        {   
                            let expected = ["n'michiba","k'michiba","michoba","n'michibnaba","k'michibnaba","k'michibaba", "michoakba"];
                            let results = generateEveryVerbAffix('michi', undefined, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, false, false);
                            test(expected, results);
                        });
                        describe("Présent", () =>
                        {
                            let expected = ["nd'aï","kd'aï","ao","nd'aïbna","kd'aïbna","kd'aïba", "aoak"];
                            let results = generateEveryVerbAffix('aï', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, false, false);
                            test(expected, results);
                        });
                        describe("Passé", () =>
                        {
                            let expected = ["nd'aïb","kd'aïb","aob","nd'aïbnob","kd'aïbnob","kd'aïb8b", "aobanik"];
                            let results = generateEveryVerbAffix('aï', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST, false, false);
                            test(expected, results);
                        });
                        describe("Passé Composé", () =>
                        {
                            let expected = ["kizi nd'aï","kizi kd'aï","kizi ao","kizi nd'aïbna","kizi kd'aïbna","kizi kd'aïba", "kizi aoak"];
                            let results = generateEveryVerbAffix('aï', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, false, false);
                            test(expected, results);
                        });
                        describe("Future", () =>
                        {
                            let expected = ["nd'aïji","kd'aïji","aoji","nd'aïbnaji","kd'aïbnaji","kd'aïbaji", "aoakji"];
                            let results = generateEveryVerbAffix('aï', undefined, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, false, false);
                            test(expected, results);
                        });
                        describe("Conditionnel", () =>
                        {
                            let expected = ["nd'aïba","kd'aïba","aoba","nd'aïbnaba","kd'aïbnaba","kd'aïbaba", "aoakba"];
                            let results = generateEveryVerbAffix('aï', undefined, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, false, false);
                            test(expected, results);
                        });
                    });
                    describe("Négatif", () => 
                    {
                        describe("Présent", () =>
                        {
                            ...
                            let results = generateEveryVerbAffix('michi', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, false, false, true);
                            test(expected, results);
                        });
                        describe("Passé", () => 
                        {                     
                            let expected = ["nda n'michiwb","nda k'michiwb","nda michowib","nda n'michiwbnob","nda k'michiwbnob","nda k'michiwb8b", "nda michowibanik"];
                            let results = generateEveryVerbAffix('michi', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST, false, false, true);
                            test(expected, results);
                        });
                        describe("Passé composé", () => 
                        {                     
                            let expected = ["asma n'michiw","asma k'michiw","asma michowi","asma n'michiwbna","asma k'michiwbna","asma k'michiwba", "asma michowiak"];
                            let results = generateEveryVerbAffix('michi', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, false, false, true);
                            test(expected, results);
                        });
                        describe("Future", () =>
                        {
                            ...
                            let results = generateEveryVerbAffix('michi', undefined, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, false, false, true);
                            test(expected, results);
                        });
                        describe("Conditionnel", () =>
                        {
                            let expected = ["ndaba n'michiw","ndaba k'michiw","ndaba michowi","ndaba n'michiwbna","ndaba k'michiwbna","ndaba k'michiwba", "ndaba michowiak"];
                            let results = generateEveryVerbAffix('michi', undefined, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, false, false, true);
                            test(expected, results);
                        });
                        describe("Présent", () =>
                        {
                            let expected = ["nda nd'aïw","nda kd'aïw","nda aowi","nda nd'aïwbna","nda kd'aïwbna","nda kd'aïwba", "nda aowiak"];
                            let results = generateEveryVerbAffix('aï', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, false, false, true);
                            test(expected, results);
                        });
                        describe("Passé", () =>
                        {
                            let expected = ["nda nd'aïwb","nda kd'aïwb","nda aowib","nda nd'aïwbnob","nda kd'aïwbnob","nda kd'aïwb8b", "nda aowibanik"];
                            let results = generateEveryVerbAffix('aï', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST, false, false, true);
                            test(expected, results);
                        });
                        describe("Passé Composé", () =>
                        {
                            let expected = ["asma nd'aïw","asma kd'aïw","asma aowi","asma nd'aïwbna","asma kd'aïwbna","asma kd'aïwba", "asma aowiak"];
                            let results = generateEveryVerbAffix('aï', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, false, false, true);
                            test(expected, results);
                        });
                        describe("Future", () =>
                        {
                            let expected = ["ndaba nd'aïw","ndaba kd'aïw","ndaba aowi","ndaba nd'aïwbna","ndaba kd'aïwbna","ndaba kd'aïwba", "ndaba aowiak"];
                            let results = generateEveryVerbAffix('aï', undefined, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, false, false, true);
                            test(expected, results);
                        });
                        describe("Conditionnel", () =>
                        {
                            let expected = ["ndaba nd'aïw","ndaba kd'aïw","ndaba aowi","ndaba nd'aïwbna","ndaba kd'aïwbna","ndaba kd'aïwba", "ndaba aowiak"];
                            let results = generateEveryVerbAffix('aï', undefined, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, false, false, true);
                            test(expected, results);
                        });                                                                                                                                                                                                              
                    });
                });            
                    ...
                    {       
                        describe("Affirmatif", () => 
                        {
                            describe("Présent", () =>
                            {
                                ...
                                let results = generateEveryVerbAffix('namih8', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, false, false);
                                test(expected, results);
                            });
                            describe("Passé", () =>
                            {
                                let expected = ["n'namih8b","k'namih8b","namihab","n'namih8bnob","k'namih8bnob","k'namih8b8b", "namihabanik"];
                                let results = generateEveryVerbAffix('namih8', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST, false, false);
                                test(expected, results);
                            });
                            describe("Passé composé", () =>
                            {
                                let expected = ["kizi n'namih8","kizi k'namih8","kizi namiha","kizi n'namih8bna","kizi k'namih8bna","kizi k'namih8ba", "kizi namihak"];
                                let results = generateEveryVerbAffix('namih8', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, false, false);
                                test(expected, results);
                            });
                            describe("Future", () =>
                            {
                                let expected = ["n'namih8ji","k'namih8ji","namihaji","n'namih8bnaji","k'namih8bnaji","k'namih8baji", "namihakji"];
                                let results = generateEveryVerbAffix('namih8', undefined, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, false, false);
                                test(expected, results);
                            });
                            describe("Conditionnel", () =>
                            {
                                let expected = ["n'namih8ba","k'namih8ba","namihaba","n'namih8bnaba","k'namih8bnaba","k'namih8baba", "namihakba"];
                                let results = generateEveryVerbAffix('namih8', undefined, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, false, false);
                                test(expected, results);
                            });
                        });
                        describe("Négatif", () => 
                           ...
                           describe("Présent", () =>
                            {
                                ...
                                let results = generateEveryVerbAffix('namih8', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, false, false, true);
                                test(expected, results);
                            });
                           describe("Passé", () =>
                            {
                                ...
                                let results = generateEveryVerbAffix('namih8', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST, false, false, true);
                                test(expected, results);
                            });
                           describe("Passé composé", () =>
                            {
                                ...
                                let results = generateEveryVerbAffix('namih8', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, false, false, true);
                                test(expected, results);
                            });
                           describe("Future", () =>
                            {
                                ...
                                let results = generateEveryVerbAffix('namih8', undefined, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, false, false, true);
                                test(expected, results);
                            });
                           describe("Conditionnel", () =>
                            {
                                let expected = ["ndaba n'namih8w","ndaba k'namih8w","ndaba namihawi","ndaba n'namih8wbna","ndaba k'namih8wbna","ndaba k'namih8wba", "ndaba namihawiak"];
                                let results = generateEveryVerbAffix('namih8', undefined, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, false, false, true);
                                test(expected, results);
                            });
                        });
                    });
                        ...
                        {                
                            describe("Singulier", () =>
                            {
                                describe("Présent", () =>
                                {
                                    ...
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, false, true);
                                    test(expected, results);
                                }); 
                                describe("Passé", () =>
                                {
                                    let expected = ["n'namih8b","k'namih8b","w'namih8bani","n'namih8nnob","k'namih8nnob","k'namih8w8b", "w'namih8w8bani"];
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST, false, true);
                                    test(expected, results);
                                });
                                describe("Passé composé", () =>
                                {
                                    let expected = ["kizi n'namih8","kizi k'namih8","kizi w'namih8","kizi n'namih8nna","kizi k'namih8nna","kizi k'namih8w8", "kizi w'namih8w8"];
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, false, true);
                                    test(expected, results);
                                });
                                describe("Future", () =>
                                {
                                    let expected = ["n'namih8ji","k'namih8ji","w'namih8ji","n'namih8nnaji","k'namih8nnaji","k'namih8w8ji", "w'namih8w8ji"];
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, false, true);
                                    test(expected, results);
                                });
                                describe("Conditionnel", () =>
                                {
                                    let expected = ["n'namih8ba","k'namih8ba","w'namih8ba","n'namih8nnaba","k'namih8nnaba","k'namih8w8ba", "w'namih8w8ba"];
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, false, true);
                                    test(expected, results);
                                });
                            });
                            describe("Pluriel", () =>
                            {
                                describe("Présent", () =>
                                {
                                    ...
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, true, true);
                                    test(expected, results);
                                });   
                                /* ??? Need some research.
                                describe("Passé", () =>
                                {
                                    let expected = ["n'namih8b","k'namih8b","w'namih8bani","n'namih8nnob","k'namih8nnob","k'namih8w8b", "w'namih8w8bani"];
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST, true, true);
                                    test(expected, results);
                                });
                                */
                                describe("Passé composé", () =>
                                {
                                    ...
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, true, true);
                                    test(expected, results);
                                });
                                describe("Future", () =>
                                {
                                    let expected = ["n'namih8kji","k'namih8kji","w'namih8ji","n'namih8nnawakji","k'namih8nnawakji","k'namih8w8kji", "w'namih8w8ji"];
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, true, true);
                                    test(expected, results);
                                });
                                describe("Conditionnel", () =>
                                {
                                    let expected = ["n'namih8kba","k'namih8kba","w'namih8ba","n'namih8nnawakba","k'namih8nnawakba","k'namih8w8kba", "w'namih8w8ba"];
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, true, true);
                                    test(expected, results);
                                });                                                              
                            });                           
                        });
                        describe("Négatif", () => 
                        {
                            ...
                            {                            
                                describe("Présent", () =>
                                {
                                    ...
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, false, true, true);
                                    test(expected, results);
                                });
                                describe("Passé", () =>
                                {
                                    ...
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST, false, true, true);
                                    test(expected, results);
                                });
                                describe("Passé composé", () =>
                                {
                                    ...
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, false, true, true);
                                    test(expected, results);
                                });
                                describe("Future", () =>
                                {
                                    ...
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, false, true, true);
                                    test(expected, results);
                                });
                                describe("Conditionnel", () =>
                                {
                                    let expected = ["ndaba n'namih8wi","ndaba k'namih8wi","ndaba w'namih8wia","ndaba n'namih8winna","ndaba k'namih8winna","ndaba k'namih8wiw8", "ndaba w'namih8wiw8"];
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, false, true, true);
                                    test(expected, results);
                                });
                            });
                            describe("Pluriel", () =>
                            {
                                describe("Présent", () =>
                                {
                                    ...
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, true, true, true);
                                    test(expected, results);
                                });   
                                /* ??? Need some research.
                                describe("Passé", () =>
                                {
                                    let expected = ["n'namih8b","k'namih8b","w'namih8bani","n'namih8nnob","k'namih8nnob","k'namih8w8b", "w'namih8w8bani"];
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST, true, true, true);
                                    test(expected, results);
                                });
                                */
                                describe("Passé composé", () =>
                                {
                                    ...
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, true, true, true);
                                    test(expected, results);
                                });
                                describe("Future", () =>
                                {
                                    ...
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, true, true, true);
                                    test(expected, results);
                                });
                                describe("Conditionnel", () =>
                                {
                                    let expected = ["ndaba n'namih8wiak","ndaba k'namih8wiak","ndaba w'namih8wia","ndaba n'namih8winnawak","ndaba k'namih8winnawak","ndaba k'namih8wiw8k", "ndaba w'namih8wiw8"];
                                    let results = generateEveryVerbAffix('namih8', Animacy.ANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, true, true, true);
                                    test(expected, results);
                                });                                                              
                            });                                                                                  
                        });                            
                    ...
                    {             
                        describe("Affirmatif", () => 
                        {
                            ...
                            {   
                                ...
                                let results = generateEveryVerbAffix('askawito', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, false, false);
                                test(expected, results);
                            });
                            describe("Passé", () => 
                            {   
                                let expected = ["nd'askawitob","kd'askawitob","askawitob","nd'askawitobnob","kd'askawitobnob","kd'askawitob8b", "askawitobanik"];
                                let results = generateEveryVerbAffix('askawito', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST, false, false);
                                test(expected, results);
                            });
                            describe("Passé composé", () => 
                            {   
                                ...
                                let results = generateEveryVerbAffix('askawito', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, false, false);
                                test(expected, results);
                            });
                            describe("Future", () => 
                            {   
                                let expected = ["nd'askawitoji","kd'askawitoji","askawitoji","nd'askawitobnaji","kd'askawitobnaji","kd'askawitobaji", "askawitoakji"];
                                let results = generateEveryVerbAffix('askawito', undefined, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, false, false);
                                test(expected, results);
                            });
                            describe("Conditional", () => 
                            {   
                                let expected = ["nd'askawitoba","kd'askawitoba","askawitoba","nd'askawitobnaba","kd'askawitobnaba","kd'askawitobaba", "askawitoakba"];
                                let results = generateEveryVerbAffix('askawito', undefined, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, false, false);
                                test(expected, results);
                            });
                        });
                        describe("Négatif", () => 
                        {
                            ...
                            {   
                                ...
                                let results = generateEveryVerbAffix('askawito', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, false, false, true);
                                test(expected, results);
                            });
                            describe("Passé", () => 
                            {   
                                ...
                                let results = generateEveryVerbAffix('askawito', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST, false, false, true);
                                test(expected, results);
                            });
                            describe("Passé composé", () => 
                            {   
                                ...
                                let results = generateEveryVerbAffix('askawito', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, false, false, true);
                                test(expected, results);
                            });
                            describe("Future", () => 
                            {   
                                ...
                                let results = generateEveryVerbAffix('askawito', undefined, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, false, false, true);
                                test(expected, results);
                            });
                            describe("Conditional", () => 
                            {   
                                let expected = ["ndaba nd'askawitow","ndaba kd'askawitow","ndaba askawitowi","ndaba nd'askawitowbna","ndaba kd'askawitowbna","ndaba kd'askawitowba", "ndaba askawitowiak"];
                                let results = generateEveryVerbAffix('askawito', undefined, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, false, false, true);
                                test(expected, results);
                            });                            
                        });
                    });
                        ...
                        {     
                            ...
                            {                                              
                                ...
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, false, true);
                                    test(expected, results);
                                });
                                describe("Passé", () => 
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST, false, true);
                                    test(expected, results);
                                });
                                describe("Passé composé", () => 
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, false, true);
                                    test(expected, results);
                                });
                                describe("Future", () => 
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, false, true);
                                    test(expected, results);
                                });
                                describe("Conditional", () => 
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, false, true);
                                    test(expected, results);
                                });
                            });
                            describe("Pluriel", () => 
                            {   
                                ...
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, true, true, false);
                                    test(expected, results);
                                });
                                /* ??? Need research 
                                describe("Passé", () => 
                                ...
                                */
                                ...
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, true, true, false);
                                    test(expected, results);
                                });
                                describe("Future", () => 
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, true, true, false);
                                    test(expected, results);
                                });
                                describe("Conditional", () => 
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, true, true, false);
                                    test(expected, results);
                                });                                                               
                            });                            
                        });
                        describe("Négatif", () => 
                        {
                            ...
                            {                              
                                ...
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, false, true, true);
                                    test(expected, results);
                                });
                                describe("Passé", () => 
                                {   
                                ...
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, false, true, true);
                                    test(expected, results);
                                }); 
                                describe("Future", () => 
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, false, true, true);
                                    test(expected, results);
                                });
                                describe("Conditionnel", () => 
                                {   
                                    let expected = ["ndaba nd'askawitowen","ndaba kd'askawitowen","ndaba wd'askawitowen","ndaba nd'askawitowenana","ndaba kd'askawitowenana","ndaba kd'askawitowen8", "ndaba wd'askawitowen8"];
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, false, true, true);
                                    test(expected, results);
                                });
                            });
                            describe("Pluriel", () => 
                            {
                                ...
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, true, true, true);
                                    test(expected, results);
                                });  
                                /* ??? Needs more research
                                describe("Passé", () => 
                                ...
                                */
                                ...
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, true, true, true);
                                    test(expected, results);
                                });
                                describe("Future", () => 
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, true, true, true);
                                    test(expected, results);
                                });
                                describe("Conditionnel", () => 
                                {   
                                    let expected = ["ndaba nd'askawitowenal","ndaba kd'askawitowenal","ndaba wd'askawitowenal","ndaba nd'askawitowenanawal","ndaba kd'askawitowenanawal","ndaba kd'askawitowen8l", "ndaba wd'askawitowen8l"];
                                    let results = generateEveryVerbAffix('askawito', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, true, true, true);
                                    test(expected, results);
                                });                                                                                                                         
                            });                                                    
                        });
                    ...
                    {            
                        ...
                        {    
                            ...
                            {   
                                ...
                                let results = generateEveryVerbAffix('waj8nem', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, false, false);
                                test(expected, results);
                            });
                            describe("Passé", () => 
                            {   
                                let expected = ["n'waj8nemob","k'waj8nemob","waj8nemob","n'waj8nemobnob","k'waj8nemobnob","k'waj8nemob8b", "waj8nemobanik"];
                                let results = generateEveryVerbAffix('waj8nem', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST, false, false);
                                test(expected, results);
                            });
                            describe("Passé composé", () => 
                            {   
                                ...
                                let results = generateEveryVerbAffix('waj8nem', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, false, false);
                                test(expected, results);
                            });
                            describe("Future", () => 
                            {   
                                let expected = ["n'waj8nemji","k'waj8nemji","waj8nemji","n'waj8nemobnaji","k'waj8nemobnaji","k'waj8nemobaji", "waj8nemokji"];
                                let results = generateEveryVerbAffix('waj8nem', undefined, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, false, false);
                                test(expected, results);
                            });
                            describe("Conditional", () => 
                            {   
                                let expected = ["n'waj8nemba","k'waj8nemba","waj8nemba","n'waj8nemobnaba","k'waj8nemobnaba","k'waj8nemobaba", "waj8nemokba"];
                                let results = generateEveryVerbAffix('waj8nem', undefined, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, false, false);
                                test(expected, results);
                            });
                        });
                        describe("Négatf", () => 
                        {
                            ...
                            {   
                                ...
                                let results = generateEveryVerbAffix('waj8nem', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, false, false, true);
                                test(expected, results);
                            });
                            describe("Past", () => 
                            {   
                                ...
                                let results = generateEveryVerbAffix('waj8nem', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST, false, false, true);
                                test(expected, results);
                            });
                            describe("Passé composé", () => 
                            {   
                                ...
                                let results = generateEveryVerbAffix('waj8nem', undefined, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, false, false, true);
                                test(expected, results);
                            });
                            describe("Future", () => 
                            {   
                                ...
                                let results = generateEveryVerbAffix('waj8nem', undefined, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, false, false, true);
                                test(expected, results);
                            });
                            describe("Conditionnel", () => 
                            {   
                                let expected = ["ndaba n'waj8nemow","ndaba k'waj8nemow","ndaba waj8nemowi","ndaba n'waj8nemowbna","ndaba k'waj8nemowbna","ndaba k'waj8nemowba", "ndaba waj8nemowiak"];
                                let results = generateEveryVerbAffix('waj8nem', undefined, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, false, false, true);
                                test(expected, results);
                            });                            
                        });
                    });
                        ...
                        describe("Affirmatif", () => 
                        {
                            ...
                            {                                
                                ...
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, false, true);
                                    test(expected, results);
                                });
                                describe("Passé", () => 
                                {   
                                    let expected = ["n'waj8nemenob","k'waj8nemenob","w'waj8nemenob","n'waj8nemenanob","k'waj8nemenanob","k'waj8nemen8b", "w'waj8nemen8b"];
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST, false, true);
                                    test(expected, results);
                                });
                                describe("Passé composé", () => 
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, false, true);
                                    test(expected, results);
                                });
                                describe("Future", () => 
                                {   
                                    let expected = ["n'waj8nemenji","k'waj8nemenji","w'waj8nemenji","n'waj8nemenanaji","k'waj8nemenanaji","k'waj8nemen8ji", "w'waj8nemen8ji"];
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, false, true);
                                    test(expected, results);
                                });
                                describe("Conditional", () => 
                                {   
                                    let expected = ["n'waj8nemenba","k'waj8nemenba","w'waj8nemenba","n'waj8nemenanaba","k'waj8nemenanaba","k'waj8nemen8ba", "w'waj8nemen8ba"];
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, false, true);
                                    test(expected, results);
                                });
                            });
                            describe("Pluriel", () => 
                            {
                                ...
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, true, true, false);
                                    test(expected, results);
                                });
                                /* Needs more research
                                describe("Passé", () => 
                                ...
                                */
                                ...
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, true, true, false);
                                    test(expected, results);
                                }); 
                                describe("Future", () => 
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, true, true, false);
                                    test(expected, results);
                                });
                                describe("Conditional", () => 
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, true, true, false);
                                    test(expected, results);
                                });                                                                                                                       
                            });                             
                        });
                        describe("Négatif", () => 
                        {
                            ...
                            {                            
                                ...
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, false, true, true);
                                    test(expected, results);
                                });
                                describe("Passé", () => 
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST, false, true, true);
                                    test(expected, results);
                                });
                                describe("Passé composé", () => 
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, false, true, true);
                                    test(expected, results);
                                });
                                describe("Future", () => 
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, false, true, true);
                                    test(expected, results);
                                });
                                describe("Conditionnel", () => 
                                {   
                                    let expected = ["ndaba n'waj8nemowen","ndaba k'waj8nemowen","ndaba w'waj8nemowen","ndaba n'waj8nemowenana","ndaba k'waj8nemowenana","ndaba k'waj8nemowen8", "ndaba w'waj8nemowen8"];
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, false, true, true);
                                    test(expected, results);
                                });
                            });
                            describe("Pluriel", () => 
                            {
                                ...
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PRESENT, true, true, true);
                                    test(expected, results);
                                });
                                /* Needs more research
                                describe("Passé", () => 
                                ...
                                */
                                ...
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.PAST_PERFECT, true, true, true);
                                    test(expected, results);
                                });
                                describe("Future", () => 
                                {   
                                    ...
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.FUTUR, true, true, true);
                                    test(expected, results);
                                });
                                describe("Conditionnel", () => 
                                {   
                                    let expected = ["ndaba n'waj8nemowenal","ndaba k'waj8nemowenal","ndaba w'waj8nemowenal","ndaba n'waj8nemowenanawal","ndaba k'waj8nemowenanawal","ndaba k'waj8nemowen8l", "ndaba w'waj8nemowen8l"];
                                    let results = generateEveryVerbAffix('waj8nem', Animacy.INANIMATE, VerbalOrder.INDEPENDENT, VerbalTense.CONDITIONAL, true, true, true);
                                    test(expected, results);
                                });                                                             
                            });                                                        
                        });
